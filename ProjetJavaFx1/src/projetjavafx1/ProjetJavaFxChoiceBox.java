...
public class ProjetJavaFxChoiceBox extends Application {
    Stage window;
    Button button;
    /**
  ...
  //ChoiceBox
    ...
    choiceBox.getSelectionModel().selectedItemProperty().addListener((v,oldValue,newValue)->System.out.println("OldValue: "+oldValue+" - New Value:"+newValue));
