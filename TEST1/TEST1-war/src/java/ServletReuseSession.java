 ...
 * @author Super
 */
@WebServlet(urlPatterns = {"/reuse"})
public class ServletReuseSession extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Réutilisation du Satefull sessionbean récupéré de la session http " + request.getContextPath() + "</h1>");
