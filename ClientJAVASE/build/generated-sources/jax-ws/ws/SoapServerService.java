 ...
 * 
 */
@WebServiceClient(name = "SoapServerService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/SoapServerService/SoapServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVERSERVICE_QNAME = new QName("http://ws/", "SoapServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SoapServerService/SoapServer?wsdl");
    ...
    public SoapServer getSoapServerPort() {
        return super.getPort(new QName("http://ws/", "SoapServerPort"), SoapServer.class);
    }
    ...
    public SoapServer getSoapServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "SoapServerPort"), SoapServer.class, features);
    }
